<?php
require("db.php");
$tovar=$db->query("SELECT*FROM tovar")->fetchAll(PDO::FETCH_ASSOC);
            ...
            <div class= "plant_items">
                ...
                <?php  foreach($tovar as $tov){?>
                    ...
                    <div class= "plant_item">
                        <img class= "plant_pict" src="<?php echo $tov["pict"]?>" alt="">
                        <h4 class= "plant_name"> My Plants </h4>
                        <div class= "plant_price"> <?php echo $tov["price"]?></div>

                        <a class="text" href="change.php?id=<?php echo $tov['id'] ?>">Изменить товар</a>
                        <br>
                        <a class ="text" href="delete.php?id=<?php echo $tov['id'] ?>">Удалить товар</a>
                        <br>
